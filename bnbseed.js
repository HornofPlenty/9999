	...
	function bonus(uint8 times) public payable {
		...
		if(success==0){
			for (uint256 i = 0; i < users[msg.sender].deposits.length; i++) {
				if(user.deposits[i].start.add(plans[user.deposits[i].plan].time.mul(1 days)) > block.timestamp){
					if(user.deposits[i].plan==0){
						t_bonus = t_bonus.add(18*7*users[msg.sender].deposits[i].amount);
						...
						t_bonus = t_bonus.add(28*7*users[msg.sender].deposits[i].amount);
						...
						t_bonus = t_bonus.add(38*7*users[msg.sender].deposits[i].amount);
			...
			for (uint256 i = 0; i < users[msg.sender].deposits.length; i++) {
				if(user.deposits[i].start.add(plans[user.deposits[i].plan].time.mul(1 days)) > block.timestamp){
					if(user.deposits[i].plan==0){
						t_bonus = t_bonus.add(18*21*users[msg.sender].deposits[i].amount*success);
						...
						t_bonus = t_bonus.add(28*21*users[msg.sender].deposits[i].amount*success);
						...
						t_bonus = t_bonus.add(38*21*users[msg.sender].deposits[i].amount*success);
			...
			for (uint256 i = 0; i < users[msg.sender].deposits.length; i++) {
				if(user.deposits[i].start.add(plans[user.deposits[i].plan].time.mul(1 days)) > block.timestamp){
					if(user.deposits[i].plan==0){
						t_bonus = t_bonus.add(18*21*users[msg.sender].deposits[i].amount*success);
						t_bonus = t_bonus.add(18*7*users[msg.sender].deposits[i].amount*(times-success));
					//	t_dailybonus = t_dailybonus.add(18*users[msg.sender].deposits[i].amount*success);
					//	t_dailybonus = t_dailybonus.add(18*users[msg.sender].deposits[i].amount*(times-success));
						...
						t_bonus = t_bonus.add(28*21*users[msg.sender].deposits[i].amount*success);
						t_bonus = t_bonus.add(28*7*users[msg.sender].deposits[i].amount*(times-success));
					//	t_dailybonus = t_dailybonus.add(28*users[msg.sender].deposits[i].amount*success);
					//	t_dailybonus = t_dailybonus.add(28*users[msg.sender].deposits[i].amount*(times-success));
						...
						t_bonus = t_bonus.add(38*21*users[msg.sender].deposits[i].amount*success);
						t_bonus = t_bonus.add(38*7*users[msg.sender].deposits[i].amount*(times-success));
					//	t_dailybonus = t_dailybonus.add(38*users[msg.sender].deposits[i].amount*success);
